...
//  Based on the work of Sébastien Lagarde: http://seblagarde.wordpress.com/2013/04/14/water-drop-3b-physically-based-wet-surfaces/
    ...
    inline half3 AddWaterRipplesFromRenderTex(LuxFragment lux, float2 dx, float2 dy)
    {
        ...
        half3 rippleNormal = UnpackNormal( tex2Dgrad(_Lux_RainRipplesRT, (lux.worldPos.xz + rippleOffset) * _Lux_RippleTiling, dx, dy).gggr );
        // Blend and fade out Ripples
...
// Snow local mapping
                ...
                :
//Snow world mapping
                //lux.baseSnowUVs.xyxy * _Lux_WorldMappedSnowTiling.xxyy; // <- undefined?
