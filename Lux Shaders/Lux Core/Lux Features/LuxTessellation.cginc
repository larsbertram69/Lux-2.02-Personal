...
void LuxTessellationDisplace (inout appdata v) 
{
    ...
    float d = tex2Dlod(_ParallaxMap, float4( v.texcoord.xy * _ParallaxToBaseRatio * _ParallaxTiling,0,0)).g * 2.0 - 1.0;
...
{
    // mix mapping
    half4 heightMask = tex2Dlod(_ParallaxMap, float4( v.texcoord.xy * _ParallaxToBaseRatio * _ParallaxTiling,0,0));
